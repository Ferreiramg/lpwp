                        ...
                        <section class="entry">
                			...
                			<div class="location-twitter fix">
						    	...
						    	<section id="office-location" class="col-left">
									...
									<ul>
										<?php if (isset($woo_options['woo_contact_title'])) { ?><li><?php echo $woo_options['woo_contact_address']; ?></li><?php } ?>
										<?php if (isset($woo_options['woo_contact_number'])) { ?><li><?php _e('Tel:','woothemes'); ?> <?php echo $woo_options['woo_contact_number']; ?></li><?php } ?>
										<?php if (isset($woo_options['woo_contact_fax'])) { ?><li><?php _e('Fax:','woothemes'); ?> <?php echo $woo_options['woo_contact_fax']; ?></li><?php } ?>
										<?php if (isset($woo_options['woo_contact_email'])) { ?><li><?php _e('Email:','woothemes'); ?> <a href="mailto:<?php echo $woo_options['woo_contact_email']; ?>"><?php echo $woo_options['woo_contact_email']; ?></a></li><?php } ?>
									</ul>
						    	</section>
