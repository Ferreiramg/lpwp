	      	...
	      	<div id="li-comment-<?php comment_ID() ?>" class="comment-container">
	            ...
	            <?php } ?>            
		      	...
		      	<div class="comment-head">
	                ...
	                <div class="date"><?php echo get_comment_date( get_option( 'date_format' ) ); ?><span class="perma"><a href="<?php echo get_comment_link(); ?>" title="<?php esc_attr_e( 'Direct link to this comment', 'woothemes' ); ?>"> #</a></span></div>
