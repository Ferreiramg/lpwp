...
if ( ! function_exists( 'woo_custom_styling' ) ) {
	function woo_custom_styling() {
		...
		if ( $settings['button_color'] != '' ) {
			$output .= 'a.button, a.comment-reply-link, #commentform #submit, #contact-page .submit, #connect .newsletter-form .submit { background: ' . $settings['button_color'] . ' !important; border-color: ' . $settings['button_color'] . ' !important; }' . "\n";
